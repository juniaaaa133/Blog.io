...
const PostDetail = () => {
  ...
  return (
    ...
    </div>
    {
      ...
      :
      <VscSettings onClick={()=>setIsOpened(true)} className='z-[3] fixed right-0 fontcl2 top-0 bottom-0 m-auto  bg-sec bcu hover:rounded-[13px] mega-trans w-[45px] h-[45px] p-[10px] shadow-md rounded-[5px]'/>
    }
