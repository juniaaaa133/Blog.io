...
const ErrorPage = ({custom_msg = null}) => {
    let error = useRouteError();

  return (
    <div className='px-[40px] flex flex-col gap-[5px] m-auto absolute top-0 right-0 left-0 bottom-0 w-fit h-fit'>
    <p className="fontcl2 logo-f text-[25px]">OOPS!</p>
    <p className="logo-f text-[16px] fontcl">{!custom_msg ? error.message : custom_msg}</p>    
    {
